...
def showMessage():
	...
	root.geometry('%sx%s+%s+%s' % (math.ceil(root.winfo_width()) + 10, math.ceil(root.winfo_height()) + 10,
	                               math.ceil((screenwidth - root.winfo_width()) / 2),
	                               math.ceil((screenheight - root.winfo_height()) / 2)))
